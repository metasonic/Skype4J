...
public class Endpoints {
    ...
    public static final Endpoints GET_ALL_CONTACTS = new Endpoints(
            "https://contacts.skype.com/contacts/v2/users/%s?delta&page_size=10000&reason=%s")
            .skypetoken();
    public static final Endpoints BLOCK_CONTACT = new Endpoints(
            "https://contacts.skype.com/contacts/v2/users/self/contacts/blocklist/%s").skypetoken();
    ...
    public static  final Endpoints SEARCH_SKYPE_DIR = new Endpoints(
            "https://skypegraph.skype.com/search/v1.1/namesearch/swx/?requestid=skype.com-1.122.11-673b53a0-adbd-4c1e-f8f5-aefde665d24e&searchstring=%s&locale=en-us");
    public static final Endpoints ADD_SKYPE_BOT = new Endpoints(
            "https://join.skype.com/api/v1/bots/add/%s").skypetoken();
    public static final Endpoints GET_SKYPE_BOT_INFO = new Endpoints(
            "https://join.skype.com/api/v1/bots/info/%s").skypetoken();


    public static  final Endpoints GET_PROFILE_INFO = new Endpoints("https://profile.skype.com/profile/v1/batch/profiles");

    public static  final Endpoints GET_MY_PROFILE_INFO = new Endpoints("https://profile.skype.com/profile/v1/users/self/profile").skypetoken();
    ...
    public static final Endpoints AUTH_REQUESTS_URL = new Endpoints(
            "https://api.skype.com/users/self/contacts/authauth-request").skypetoken();
...
//            .regtoken();
    ...
    public static final Endpoints CONTACT_INFO = new Endpoints(
            "https://api.skype.com/users/self/https://api.skype.com/users/self/contacts/auth-requestcontacts/profiles").skypetoken();
